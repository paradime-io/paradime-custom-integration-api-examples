#!/usr/bin/env python3
"""
Full pipeline for Snowflake Notebooks custom integration.

Runs the complete pipeline:
  1. Parse .ipynb notebook files and generate nodes (parse.py).
...
def main() -> None:
    ...
    print("Snowflake Notebooks → Parse → Upload to Paradime")
    print("=" * 60)
    ...
    if not run_step("Parse Snowflake Notebooks", script_dir / "parse.py"):
